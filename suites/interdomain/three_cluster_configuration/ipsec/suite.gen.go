...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster1`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster3`)
