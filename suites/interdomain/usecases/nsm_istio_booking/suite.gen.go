...
func (s *Suite) SetupSuite() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/istio/istio/release-1.13/samples/bookinfo/platform/kube/bookinfo.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_istio_booking/nse-auto-scale ` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../../examples/interdomain/usecases/nsm_istio_booking/productpage/productpage.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_istio_booking/netsvc.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete ns istio-system` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection-` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	})
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_istio_booking/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_istio_booking/productpage/productpage.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_istio_booking/nse-auto-scale`)
