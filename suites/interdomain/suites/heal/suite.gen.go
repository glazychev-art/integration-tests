...
func (s *Suite) TestHeal_floating_forwarder_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster1`)
...
func (s *Suite) TestHeal_floating_nse_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/heal_floating-nse-death/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_floating-nse-death/cluster2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-floating-nse-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_floating-nse-death/cluster1`)
...
func (s *Suite) TestHeal_floating_nsm_system_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster1`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster3`)
...
func (s *Suite) TestHeal_interdomain_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-nsmgr-death/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-nsmgr-death/cluster1`)
...
func (s *Suite) TestHeal_interdomain_proxy_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster1`)
...
func (s *Suite) TestHeal_interdomain_registry_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-registry-death/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-registry-death/cluster1`)
