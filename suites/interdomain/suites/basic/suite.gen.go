...
func (s *Suite) TestFloating_Kernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster1`)
...
func (s *Suite) TestFloating_Kernel2Ethernet2Memif() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Memif/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Memif/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Memif/cluster1`)
...
func (s *Suite) TestFloating_Kernel2IP2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Kernel/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Kernel/cluster1`)
...
func (s *Suite) TestFloating_Kernel2IP2Memif() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Memif/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Memif/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2IP2Memif/cluster1`)
...
func (s *Suite) TestFloating_Memif2Ethernet2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Kernel/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Kernel/cluster1`)
...
func (s *Suite) TestFloating_Memif2Ethernet2Memif() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Memif/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Memif/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Memif2Ethernet2Memif/cluster1`)
...
func (s *Suite) TestFloating_Memif2IP2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Kernel/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Kernel/cluster1`)
...
func (s *Suite) TestFloating_Memif2IP2Memif() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Memif/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Memif/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Memif2IP2Memif/cluster1`)
...
func (s *Suite) TestFloating_dns() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_dns/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_dns/cluster2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_dns/cluster1`)
...
func (s *Suite) TestFloating_nse_composition() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_nse_composition/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_nse_composition/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_nse_composition/cluster1`)
...
func (s *Suite) TestFloating_vl3_basic() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster3`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster2`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster1`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_vl3-basic/cluster2`)
...
func (s *Suite) TestFloating_vl3_dns() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster3`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster2`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster1`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-floating-vl3-dns`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster2`)
...
func (s *Suite) TestFloating_vl3_scale_from_zero() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster3`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster2`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster1`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster3`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_vl3-scale-from-zero/cluster2`)
...
func (s *Suite) TestInterdomain_Kernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2Ethernet2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2Ethernet2Kernel/cluster1`)
...
func (s *Suite) TestInterdomain_Kernel2IP2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2IP2Kernel/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2IP2Kernel/cluster1`)
...
func (s *Suite) TestInterdomain_dns() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/interdomain_dns/cluster2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/interdomain_dns/cluster1`)
