...
func (s *Suite) TestNsm_consul() {
	...
	s.T().Cleanup(func() {
		...
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../../examples/interdomain/usecases/nsm_consul/server/counting_nsm.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../../examples/interdomain/usecases/nsm_consul/client/dashboard.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_consul/nse-auto-scale-client` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_consul/nse-auto-scale-server` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_consul/service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_consul/server/counting_service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_consul/netsvc.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_consul/server/counting_service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_consul/server/counting.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_consul/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_consul/nse-auto-scale-client` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_consul/nse-auto-scale-server`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_consul/service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_consul/client/dashboard.yaml`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_consul/server/counting_nsm.yaml`)
...
func (s *Suite) TestNsm_consul_vl3() {
	...
	s.T().Cleanup(func() {
		r.Run(`pkill -f "port-forward"`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster1`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster2`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster2`)
...
func (s *Suite) TestNsm_istio() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_istio/greeting/server.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_istio/nse-auto-scale` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../../examples/interdomain/usecases/nsm_istio/greeting/client.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../../examples/interdomain/usecases/nsm_istio/netsvc.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete ns istio-system` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection-` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	})
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_istio/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_istio/greeting/client.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_istio/nse-auto-scale`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection=enabled` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_istio/greeting/server.yaml`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/vl3-dns` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
	...
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `resources:` + "\n" + `- control-plane.yaml` + "\n" + `` + "\n" + `patches:` + "\n" + `- path: ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/patch-control-plane.yaml` + "\n" + `EOF`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k .`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-redis.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=redis`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-app.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=demo-app`)
