...
func (s *Suite) TestNsm_consul() {
	...
	s.T().Cleanup(func() {
		...
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../examples/interdomain/nsm_consul/nse-auto-scale`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../examples/interdomain/nsm_consul/client/dashboard.yaml`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_consul/networkservice.yaml`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_consul/nse-auto-scale`)
