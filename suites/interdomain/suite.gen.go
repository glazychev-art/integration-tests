...
func (s *Suite) TestNsm_consul() {
	...
	s.T().Cleanup(func() {
		...
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../examples/interdomain/nsm_consul/server/counting_nsm.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../examples/interdomain/nsm_consul/client/dashboard.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../examples/interdomain/nsm_consul/nse-auto-scale-client` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../examples/interdomain/nsm_consul/nse-auto-scale-server` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_consul/service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_consul/server/counting_service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_consul/networkservice.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_consul/server/counting_service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_consul/server/counting.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_consul/networkservice.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_consul/nse-auto-scale-client` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_consul/nse-auto-scale-server`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_consul/service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/interdomain/nsm_consul/client/dashboard.yaml`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/interdomain/nsm_consul/server/counting_nsm.yaml`)
...
func (s *Suite) TestNsm_istio() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_istio/greeting/server.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../examples/interdomain/nsm_istio/nse-auto-scale` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f ../../../examples/interdomain/nsm_istio/greeting/client.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_istio/networkservice.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete ns istio-system` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection-` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	})
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_istio/networkservice.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/interdomain/nsm_istio/greeting/client.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_istio/nse-auto-scale`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection=enabled` + "\n" + `` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_istio/greeting/server.yaml`)
