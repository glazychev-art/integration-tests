...
func (s *Suite) TestNsm_consul() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_consul/netsvc.yaml`)
...
func (s *Suite) TestNsm_istio() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_istio/netsvc.yaml`)
