...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG1 ]]`)
	r.Run(`[[ ! -z $KUBECONFIG2 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/interdomain/spire/cluster1` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/spire/cluster2`)
