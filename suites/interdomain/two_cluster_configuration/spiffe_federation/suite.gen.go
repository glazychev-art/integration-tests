...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/two_cluster_configuration/spiffe_federation/cluster1-spiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/two_cluster_configuration/spiffe_federation/cluster2-spiffeid-template.yaml`)
