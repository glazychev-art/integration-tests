...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/two_cluster_configuration/basic/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/two_cluster_configuration/basic/cluster2`)
