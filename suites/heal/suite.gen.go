...
func (s *Suite) TestLocal_nse_death() {
	...
	r.Run(`kubectl apply -k ../../../examples/heal/local-nse-death/nse-before-death`)
	...
	r.Run(`kubectl apply -k ../../../examples/heal/local-nse-death/nse-after-death`)
...
func (s *Suite) TestSpire_agent_restart() {
	...
	r.Run(`kubectl apply -k ../../../examples/heal/spire-agent-restart`)
...
func (s *Suite) TestSpire_server_agent_restart() {
	...
	r.Run(`kubectl apply -k ../../../examples/heal/spire-server-agent-restart`)
...
func (s *Suite) TestSpire_server_restart() {
	...
	r.Run(`kubectl apply -k ../../../examples/heal/spire-server-restart`)
...
func (s *Suite) TestSpire_upgrade() {
	...
	r.Run(`kubectl apply -k ../../../examples/heal/spire-upgrade`)
	...
	r.Run(`kubectl apply -k ../../../examples/spire/single_cluster`)
	r.Run(`kubectl wait --for=condition=ready --timeout=3m pod -l app=spire-server -n spire`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-agent -n spire`)
	r.Run(`kubectl apply -f ../../../examples/spire/single_cluster/clusterspiffeid-template.yaml`)
	r.Run(`kubectl apply -f ../../../examples/spire/base/clusterspiffeid-webhook-template.yaml`)
	r.Run(`kubectl exec pods/alpine -n ns-spire-upgrade -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec deployments/nse-kernel -n ns-spire-upgrade -- ping -c 4 172.16.1.101`)
}
