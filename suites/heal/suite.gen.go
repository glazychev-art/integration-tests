...
func (s *Suite) TestDataplane_interrupt() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-dataplane-interrupt --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-dataplane-interrupt --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-dataplane-interrupt -- ping -c 4 172.16.1.100 -I 172.16.1.101`)
	r.Run(`kubectl exec ${NSE} -n ns-dataplane-interrupt -- ping -c 4 172.16.1.101 -I 172.16.1.100`)
	...
	r.Run(`kubectl exec ${NSC} -n ns-dataplane-interrupt -- ip link set nsm-1 down`)
	r.Run(`kubectl exec ${NSC} -n ns-dataplane-interrupt -- sh -c 'timeout 10 sh -c "while ! [ -f \"$1\" ];do sleep 1; done"' - "$PINGER_PATH"`)
	r.Run(`kubectl exec ${NSC} -n ns-dataplane-interrupt -- ping -c 4 172.16.1.100 -I 172.16.1.101`)
	r.Run(`kubectl exec ${NSE} -n ns-dataplane-interrupt -- ping -c 4 172.16.1.101 -I 172.16.1.100`)
}
func (s *Suite) TestLocal_forwarder_death() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-forwarder-death --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestLocal_forwarder_remote_forwarder() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-forwarder-remote-forwarder --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestLocal_nse_death() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-nse-death --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-local-nse-death --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-local-nse-death -- ping -c 4 172.16.1.100 -I 172.16.1.101`)
	r.Run(`kubectl exec ${NSE} -n ns-local-nse-death -- ping -c 4 172.16.1.101 -I 172.16.1.100`)
	r.Run(`kubectl scale deployment nse-kernel -n ns-local-nse-death --replicas=0`)
	r.Run(`kubectl exec ${NSC} -n ns-local-nse-death -- ping -c 4 172.16.1.100 -I 172.16.1.101 2>&1 | egrep "100% packet loss|Network unreachable|can't set multicast source"`)
	...
	r.Run(`kubectl exec ${NSC} -n ns-local-nse-death -- ping -c 4 172.16.1.102 -I 172.16.1.103`)
...
func (s *Suite) TestLocal_nsm_system_restart() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-nsm-system-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestLocal_nsmgr_remote_nsmgr() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-nsmgr-remote-nsmgr --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestLocal_nsmgr_restart() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-local-nsmgr-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRegistry_local_endpoint() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-registry-local-endpoint --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRegistry_remote_forwarder() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-registry-remote-forwarder --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRegistry_remote_nsmgr() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-registry-remote-nsmgr --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRegistry_restart() {
	...
	r.Run(`NEW_NSC=$(kubectl get pods -l app=alpine-new -n ns-registry-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_forwarder_death() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-forwarder-death --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_forwarder_death_ip() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-forwarder-death-ip --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_nse_death_ip() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-nse-death-ip --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_nsmgr_death() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-nsmgr-death --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_nsmgr_remote_endpoint() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-nsmgr-remote-endpoint --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_nsmgr_restart() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-nsmgr-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestRemote_nsmgr_restart_ip() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-remote-nsmgr-restart-ip --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestSpire_agent_restart() {
	...
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nsc-kernel -n ns-spire-agent-restart`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-spire-agent-restart`)
	r.Run(`NSC=$(kubectl get pods -l app=nsc-kernel -n ns-spire-agent-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-spire-agent-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-agent-restart -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-agent-restart -- ping -c 4 172.16.1.101`)
...
func (s *Suite) TestSpire_server_agent_restart() {
	...
	r.Run(`kubectl apply -k .`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nsc-kernel -n ns-spire-server-agent-restart`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-spire-server-agent-restart`)
	r.Run(`NSC=$(kubectl get pods -l app=nsc-kernel -n ns-spire-server-agent-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-spire-server-agent-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-server-agent-restart -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-server-agent-restart -- ping -c 4 172.16.1.101`)
	r.Run(`AGENTS=$(kubectl get pods -l app=spire-agent -n spire --template '{{range .items}}{{.metadata.name}}{{" "}}{{end}}')`)
...
func (s *Suite) TestSpire_server_restart() {
	...
	r.Run(`kubectl apply -k .`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nsc-kernel -n ns-spire-server-restart`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-spire-server-restart`)
	r.Run(`NSC=$(kubectl get pods -l app=nsc-kernel -n ns-spire-server-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-spire-server-restart --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-server-restart -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-server-restart -- ping -c 4 172.16.1.101`)
	r.Run(`kubectl delete pod spire-server-0 -n spire`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-server -n spire`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-server-restart -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-server-restart -- ping -c 4 172.16.1.101`)
...
func (s *Suite) TestSpire_upgrade() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=nsc-kernel -n ns-spire-upgrade --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-spire-upgrade --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-upgrade -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-upgrade -- ping -c 4 172.16.1.101`)
	r.Run(`kubectl delete crd spiffeids.spiffeid.spiffe.io` + "\n" + `kubectl delete ns spire`)
	r.Run(`kubectl apply -k ../../spire/single_cluster`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-server -n spire`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-agent -n spire`)
	r.Run(`kubectl exec ${NSC} -n ns-spire-upgrade -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-spire-upgrade -- ping -c 4 172.16.1.101`)
