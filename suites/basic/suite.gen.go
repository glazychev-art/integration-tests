...
func (s *Suite) TestKernel2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Vxlan2Kernel`)
...
func (s *Suite) TestKernel2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Vxlan2Memif`)
...
func (s *Suite) TestKernel2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Wireguard2Kernel`)
...
func (s *Suite) TestKernel2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Wireguard2Memif`)
...
func (s *Suite) TestMemif2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Vxlan2Kernel`)
...
func (s *Suite) TestMemif2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Vxlan2Memif`)
...
func (s *Suite) TestMemif2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Wireguard2Kernel`)
...
func (s *Suite) TestMemif2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Wireguard2Memif`)
