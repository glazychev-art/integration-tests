...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/basic?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2IP2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2IP2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Ethernet2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Ethernet2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2IP2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2IP2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Kernel?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Memif?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
