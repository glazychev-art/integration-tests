...
func (s *Suite) TestKernel2Vxlan2Kernel() {
	...
	s.T().Cleanup(func() {
		...
		r.Run(`kubectl describe pods -n nsm-system`)
		r.Run(`kubectl logs ${NSC} -n ${NAMESPACE2}`)
		r.Run(`pwd`)
		r.Run("kubectl cluster-info dump -A --output-directory=/home/runner/work/integration-k8s-kind/integration-k8s-kind/src/github.com/networkservicemesh/integration-k8s-kind/interdomain-ipv6-logs/cluster-1")
		r.Run(`kubectl delete ns ${NAMESPACE2}`)

		r.Run(`export KUBECONFIG=$KUBECONFIG2`)
		r.Run("kubectl cluster-info dump -A --output-directory=/home/runner/work/integration-k8s-kind/integration-k8s-kind/src/github.com/networkservicemesh/integration-k8s-kind/interdomain-ipv6-logs/cluster-2")
		r.Run(`kubectl delete ns ${NAMESPACE1}`)
	})
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`NAMESPACE1=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2b4374aec83267373830d4ad69e7b9a661b51810/examples/floating_interdomain/usecases/namespace.yaml)[0])` + "\n" + `NAMESPACE1=${NAMESPACE1:10}`)
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`NAMESPACE2=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2b4374aec83267373830d4ad69e7b9a661b51810/examples/floating_interdomain/usecases/namespace.yaml)[0])` + "\n" + `NAMESPACE2=${NAMESPACE2:10}`)
