...
func (s *Suite) TestFloating_Kernel2Vxlan2Kernel() {
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster3`)
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster2`)
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster1`)
...
func (s *Suite) TestFloating_Kernel2Wireguard2Kernel() {
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster3`)
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster2`)
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster1`)
...
func (s *Suite) TestFloating_vl3_basic() {
	...
	s.T().Cleanup(func() {
		r.Run(`export KUBECONFIG=$KUBECONFIG3 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster3`)
		r.Run(`export KUBECONFIG=$KUBECONFIG2 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster2`)
		r.Run(`export KUBECONFIG=$KUBECONFIG1 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster1`)
	})
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster3`)
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster1`)
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster2`)
...
func (s *Suite) TestFloating_vl3_scale_from_zero() {
	...
	s.T().Cleanup(func() {
		r.Run(`export KUBECONFIG=$KUBECONFIG3 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster3`)
		r.Run(`export KUBECONFIG=$KUBECONFIG2 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster2`)
		r.Run(`export KUBECONFIG=$KUBECONFIG1 && kubectl delete -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster1`)
	})
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster3`)
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster1`)
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster2`)
...
func (s *Suite) TestInterdomain_Kernel2Vxlan2Kernel() {
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Vxlan2Kernel/cluster2`)
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Vxlan2Kernel/cluster1`)
...
func (s *Suite) TestInterdomain_Kernel2Wireguard2Kernel() {
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Wireguard2Kernel/cluster2`)
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Wireguard2Kernel/cluster1`)
