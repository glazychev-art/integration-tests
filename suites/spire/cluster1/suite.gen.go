...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG1 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/spire/cluster1`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/spire/cluster1/clusterspiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/spire/base/clusterspiffeid-webhook-template.yaml`)
}
func (s *Suite) Test() {}
