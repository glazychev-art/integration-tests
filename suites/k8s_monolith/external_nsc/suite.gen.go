...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../examples/k8s_monolith/configuration/cluster`)
...
func (s *Suite) TestKernel2Wireguard2Kernel() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../examples/k8s_monolith/external_nsc/usecases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
