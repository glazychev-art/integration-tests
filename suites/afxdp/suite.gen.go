...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../examples/afxdp`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ns-dns -- dig kubernetes.default A kubernetes.default AAAA | grep "kubernetes.default.svc.cluster.local"`)
}
...
func (s *Suite) TestKernel2Wireguard2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k ../../../../examples/features/dual-stack/Kernel2Wireguard2Kernel_dual_stack`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`NSC=$(kubectl get pods -l app=alpine -n ns-exclude-prefixes --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
...
func (s *Suite) TestKernel2Wireguard2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k ../../../../examples/features/ipv6/Kernel2Wireguard2Kernel_ipv6`)
...
func (s *Suite) TestKernel2Wireguard2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k ../../../../examples/features/ipv6/Kernel2Wireguard2Memif_ipv6`)
...
func (s *Suite) TestMemif2Wireguard2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k ../../../../examples/features/ipv6/Memif2Wireguard2Kernel_ipv6`)
...
func (s *Suite) TestMemif2Wireguard2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k ../../../../examples/features/ipv6/Memif2Wireguard2Memif_ipv6`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k ../../../examples/features/vl3-basic`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Ethernet2Kernel`)
	...
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-kernel2ethernet2kernel --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-kernel2ethernet2kernel -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec ${NSE} -n ns-kernel2ethernet2kernel -- ping -c 4 172.16.1.101`)
}
func (s *Suite) TestKernel2Ethernet2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Ethernet2Memif`)
	...
	r.Run(`NSE=$(kubectl get pods -l app=nse-memif -n ns-kernel2ethernet2memif --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl exec ${NSC} -n ns-kernel2ethernet2memif -- ping -c 4 172.16.1.100`)
	r.Run(`result=$(kubectl exec "${NSE}" -n "ns-kernel2ethernet2memif" -- vppctl ping 172.16.1.101 repeat 4)` + "\n" + `echo ${result}` + "\n" + `! echo ${result} | grep -E -q "(100% packet loss)|(0 sent)|(no egress interface)"`)
}
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2IP2Kernel`)
...
func (s *Suite) TestKernel2IP2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2IP2Memif`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Kernel`)
...
func (s *Suite) TestKernel2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Memif`)
...
func (s *Suite) TestMemif2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Ethernet2Kernel`)
	...
	r.Run(`NSE=$(kubectl get pods -l app=nse-kernel -n ns-memif2ethernet2kernel --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`result=$(kubectl exec "${NSC}" -n "ns-memif2ethernet2kernel" -- vppctl ping 172.16.1.100 repeat 4)` + "\n" + `echo ${result}` + "\n" + `! echo ${result} | grep -E -q "(100% packet loss)|(0 sent)|(no egress interface)"`)
	r.Run(`kubectl exec ${NSE} -n ns-memif2ethernet2kernel -- ping -c 4 172.16.1.101`)
}
func (s *Suite) TestMemif2Ethernet2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Ethernet2Memif`)
	...
	r.Run(`NSE=$(kubectl get pods -l app=nse-memif -n ns-memif2ethernet2memif --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`result=$(kubectl exec "${NSC}" -n "ns-memif2ethernet2memif" -- vppctl ping 172.16.1.100 repeat 4)` + "\n" + `echo ${result}` + "\n" + `! echo ${result} | grep -E -q "(100% packet loss)|(0 sent)|(no egress interface)"`)
	r.Run(`result=$(kubectl exec "${NSE}" -n "ns-memif2ethernet2memif" -- vppctl ping 172.16.1.101 repeat 4)` + "\n" + `echo ${result}` + "\n" + `! echo ${result} | grep -E -q "(100% packet loss)|(0 sent)|(no egress interface)"`)
}
func (s *Suite) TestMemif2IP2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2IP2Kernel`)
...
func (s *Suite) TestMemif2IP2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2IP2Memif`)
...
func (s *Suite) TestMemif2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Kernel`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Memif2Memif`)
