...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/0c2763dc113ed9e6728203b940142ae42c479609/examples/features/annotated-namespace/client.yaml`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dns?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes-client?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/multiple-services?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/mutually-aware-nses?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/nse-composition?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/opa?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/policy-based-routing?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scale-from-zero?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scaled-registry?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
//	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-scaled-registry`)
//	r.Run(`kubectl get nses -A | grep nse-kernel`)
...
//	r.Run(`kubectl get nses -A | grep -v nse-kernel`)
//}
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/select-forwarder?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-basic?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-lb?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-scale-from-zero?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
...
//	})
//	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/webhook?ref=0c2763dc113ed9e6728203b940142ae42c479609`)
