...
func (s *Suite) TestDns() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl logs ${NSC} -n ${NAMESPACE} -c coredns`)
		r.Run(`kubectl logs ${NSE} -n ${NAMESPACE} -c coredns`)
		r.Run(`kubectl logs --namespace=kube-system -l k8s-app=kube-dns --tail -1`)
	...
	//r.Run(`sleep 1m`)
	r.Run(`NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	...
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ${NAMESPACE} -- cat /etc/resolv.conf`)
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ${NAMESPACE} -- nslookup kubernetes.default`)
	r.Run(`kubectl -n kube-system describe configmap coredns`)
	r.Run(`kubectl get pods -l k8s-app=kube-dns -n kube-system -o wide`)
	r.Run(`kubectl describe pod -l k8s-app=kube-dns -n kube-system`)
	r.Run(`kubectl get pods --namespace=kube-system -l k8s-app=kube-dns`)
	//r.Run(`kubectl logs --namespace=kube-system -l k8s-app=kube-dns --tail -1`)
	r.Run(`kubectl get svc --namespace=kube-system`)
	r.Run(`kubectl get endpoints kube-dns --namespace=kube-system`)
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ${NAMESPACE} -- dig +trace my.coredns.service`)
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ${NAMESPACE} -- ping -c 4 my.coredns.service`)
	r.Run(`kubectl exec ${NSC} -c dnsutils -n ${NAMESPACE} -- nslookup kubernetes.default`)
}

func (s *Suite) TestPolicyBasedRouting() {
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/use-cases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`NODE=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}')[0])`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/use-cases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `resources:` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/exclude-prefixes-client/test-client.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/exclude-prefixes-client/nsm-service-1.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/exclude-prefixes-client/nsm-service-2.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/exclude-prefixes-client/nse-kernel-1.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/exclude-prefixes-client/nse-kernel-2.yaml` + "\n" + `EOF`)
	r.Run(`kubectl apply -k .`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=alpine -n ${NAMESPACE}`)
...
//	r.Run(`NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
//	r.Run(`NODE=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}')[0])`)
//	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `resources:` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/nse-composition/config-file.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/nse-composition/passthrough-1.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/nse-composition/passthrough-2.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/nse-composition/passthrough-3.yaml` + "\n" + `- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/nse-composition/nse-composition-ns.yaml` + "\n" + `- client.yaml` + "\n" + `bases:` + "\n" + `- https://github.com/networkservicemesh/deployments-k8s/apps/nse-kernel?ref=7207a42044c4636ba6701e5f86084eb68aa4af4f` + "\n" + `- https://github.com/networkservicemesh/deployments-k8s/examples/features/nse-composition/nse-firewall?ref=7207a42044c4636ba6701e5f86084eb68aa4af4f` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
//	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7207a42044c4636ba6701e5f86084eb68aa4af4f/examples/features/scale-from-zero/autoscale-netsvc.yaml`)
//	r.Run(`kubectl apply -k .`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/select-forwarder?ref=7207a42044c4636ba6701e5f86084eb68aa4af4f`)
