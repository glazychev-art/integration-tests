...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag`)
...
func (s *Suite) TestKernel2Kernel_Vfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Kernel2Kernel_Vfio2NoopVlanTag`)
...
func (s *Suite) TestSriovKernel2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/SriovKernel2NoopVlanTag/ponger`)
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/SriovKernel2NoopVlanTag`)
...
func (s *Suite) TestVfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k ../../../examples/use-cases/Vfio2NoopVlanTag`)
